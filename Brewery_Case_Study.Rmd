...
# It can be seen above that there is an exceptionally high concentration of breweries in Colorado, with California and Michigan not far behind. Colorado is the microbrewing capital of the US because it was 'ground zero' for the microbrewing explosion.  Home to Coors, Colorado has had a long tradition of brewing, and many beer festivals, that primed it to take its position as the craft brewing capital of the US when home-brewing was legalized in 1979.

# Other factors, such as brewing a distribution laws, are responsible for brewery concentration.  In  Michigan, brewers are allowed to sell their brews directly to customers if they produce less than 1,000 barrels annually, otherwise they must work with a distribution company, who often take up toa 30% cut of the profits.  This encourages the formation of many small breweries.
...
# The state with the highest alcohol content beer is Colorado (12.8%) with Kentucky in second at 12.5%.  
# The state with the  most bitter beer is Oregon (138 IBU) with Virginia in second at 135.  
# It is interesting to note that Utah does not have the weakest maximum ABV beer given their alcohol laws, but that Missouri and Tennesse have the weakest maximum ABV beer.
# Missouri and Tennessee also have the lowest maximum IBU indicating an aversion to bitter beer, or at least a weak microbrewing industry.
...
# The above plot visualizes the performance of the model. The model tends to guess that a beer is an IPA when the IBU rating is above ~ 55-60, and it is quite successful at doing so. It also tends to guess that a beer is an ale at alcohol contents below 4%, but that is the only insight it provides regarding ABV.  This is clarified and further explored below.
...
# Create 2D scatterplots of probability of being an ale vs ABV and probability of being an ale vs IBU colored by the beer's style.  This confirms that IBU and the probability of being an ale are correlated, while ABV and probability of being an ale are not.
```{r}
class_df$`Ale Probability` = class_df$AleProb * 100
...
# The most noticeable trend is the popularity of ales in the midwest, and of IPAs on the west coast and in New England.
